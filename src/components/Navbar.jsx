	...
	return (
		<div className='fixed w-full h-[80px] flex justify-between items-center px-4 bg-[#0a192f] text-gray-300'>
			...
			<ul className='hidden md:flex gap-x-20 '>
				<li>
					<Link
						className='hover:border-b-pink-600 hover:border-b-2'
						to='home'
						smooth={true}
						duration={500}
					>
			...
			<div className='hidden lg:flex fixed flex-col top-[35%] left-0'>
				<ul>
					<li className='w-[160px] h-[60px] flex justify-between items-center ml-[-100px] hover:ml-[4px] duration-300 bg-blue-600'>
						<a
